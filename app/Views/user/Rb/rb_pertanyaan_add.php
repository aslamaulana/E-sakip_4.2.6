...
<div class="card-body">
	...
	<form action="<?= base_url('/user/rb/rb_pertanyaan/rb_pertanyaan_create') ?>" method="POST">
		<?= csrf_field() ?>
		...
		<table id="example1" class="table table-bordered table-sm">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" class="form-control" style="height:30px;" name="jawaban_pertanyaan" maxlength="10"></td>
				</tr>
				<?php
				...
				?>
					<tr>
						...
						<td>
							<input type="text" class="form-control" style="height:30px;" name="jawaban_pertanyaan_sub[]" maxlength="10">
					...
					?>
						<tr>
							...
							<td>
								<input type="text" class="form-control" style="height:30px;" name="jawaban_pertanyaan_sub_sub[]" maxlength="10">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<textarea name="link_keterangan" class="form-control" placeholder="Keterangan" maxlength="300" rows="8" required></textarea>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
