				...
				?>
					<tr>
						...
						<td class="text-center">
							...
							<?= $rb_pertanyaan_jawaban_sub['jawaban']; ?>
						</td>
					</tr>
					<?php
					...
					?>
						<tr>
							...
							<td class="text-center">
								...
								<?= $rb_pertanyaan_jawaban_sub_sub['jawaban']; ?>
							</td>
						</tr>
					<?php endforeach; ?>
				<?php endforeach; ?>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<textarea name="link_keterangan" class="form-control" placeholder="Keterangan" maxlength="300" rows="8" required readonly><?= $jawaban['link_keterangan']; ?></textarea>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label>Link Evidence 1</label>
					<input type="text" class="form-control" value="<?= $jawaban['link_1']; ?>" required readonly>
				</div>
				<div class="form-group">
					<label>Link Evidence 2</label>
					<input type="text" class="form-control" value="<?= $jawaban['link_2']; ?>" readonly>
				</div>
				<div class="form-group">
					<label>Link Evidence 3</label>
					<input type="text" class="form-control" value="<?= $jawaban['link_3']; ?>" readonly>
				</div>
			</div>
		</div>
	</form>
